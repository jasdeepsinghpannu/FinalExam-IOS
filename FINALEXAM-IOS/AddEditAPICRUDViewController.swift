...
class AddEditAPICRUDViewController: UIViewController {
    ...
    var movie: Movie?
    // Used for MovieViewController to pass data to AddEditAPICRUDViewController
    ...
    @IBAction func UpdateButton_Pressed(_ sender: UIButton) {
        ...
        if let movie = movie {
            requestType = "PUT"
            urlString = "https://mdev1004-m2024-assignment1-wlzg.onrender.com/api/movie/update/\(movie._id)"
        }
        else {
            requestType = "POST"
            urlString = "https://mdev1004-m2024-assignment1-wlzg.onrender.com/api/movie/add"
